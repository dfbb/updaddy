...
pub use adapter::{
    classify_command_error, command, home_dir, home_path, package_record, validate_name,
    CommandRunner, EcosystemAdapter, ExecutorContext, ProcessCommandRunner, ProxyEnv,
};
